    ...
    def get(self, request, id: int) -> Response:
        ...
        data = [
            {
                ...
                "total_supply": col.post.total_supply,
                "minted_count": col.post.minted_count,
                "creator_username": col.post.owner.username,
                "creator_avatar": col.post.owner.avatar.url if col.post.owner.avatar else None,
                "creator_official": getattr(col.post.owner, "official", False),
                "creator_seeker_verified": getattr(col.post.owner, "seeker_verified", False),
        ...
        return Response({
            "user": {
                ...
                "seeker_verified": getattr(profile_user, "seeker_verified", False),
            },
            "data": data,

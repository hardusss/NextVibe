...
from .view_pac import (
    ...
    MintNftView, CollectPrepareView, CollectSubmitView,
    UserCollectionView, GetVibemapNFTsView, GetVibemapEventsView,
...
urlpatterns = [
    ...
    path("collect/prepare/", CollectPrepareView.as_view(), name="collect_prepare"),
    path("collect/submit/", CollectSubmitView.as_view(), name="collect_submit"),
    ...
    path("irl-tap/", IRLTapView.as_view(), name="irl_tap"),
    path("active-checkin/", ActiveCheckinView.as_view(), name="active_checkin"),

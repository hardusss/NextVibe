...
from .view_pac import (
    ...
    GetMediaView, ModerationCallbackView
    )
...
urlpatterns = [
    ...
    path("comment-like/<int:post_id>/<int:comment_id>/", LikeCommentView.as_view(), name="comment_like"),
    ...
    path("get-media/", GetMediaView.as_view(), name="get_media"),

...
from .views import ChatListView, OnlineUsersView, CreateChatView, DeleteChatView, CherryEmbedTokenView, CherryRoomMessagesView
...
urlpatterns = [
    ...
    path('<str:room_id>/messages/', CherryRoomMessagesView.as_view(), name='cherry-room-messages'),
]
